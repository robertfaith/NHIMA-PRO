...
const AgentStage5Security = ({ form, onChange }: Props) => (
  <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
    <p style={{ fontSize:'13px', color:'rgba(255,255,255,0.6)', lineHeight:1.6 }}>
      Upload your NRC and NHIMA Agent Licence document.
    </p>
    <UploadField label="NRC — Front Side"        value={form.nrcFrontUrl}  onChange={(v) => onChange('nrcFrontUrl',  v)} />
    <UploadField label="NHIMA Agent Licence Doc"  value={form.licenseDocUrl} onChange={(v) => onChange('licenseDocUrl', v)} />
  </div>
)

export default AgentStage5Security